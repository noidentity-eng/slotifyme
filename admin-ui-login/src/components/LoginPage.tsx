...
const LoginPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen w-full bg-gradient-to-br from-slate-900 via-blue-950 to-slate-900 flex items-center justify-center p-4 sm:p-6 lg:p-8 relative">
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-slate-900/30 via-blue-950/20 to-slate-900/30"></div>
      ...
      <div className="w-full max-w-md mx-auto relative">
        <div className="bg-white/95 backdrop-blur-sm rounded-2xl shadow-2xl p-6 sm:p-8 transition-all duration-500 hover:shadow-3xl border border-slate-200/20">
          ...
          <div className="text-center mb-6 sm:mb-8">
            <div className="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-r from-amber-400 to-amber-600 rounded-full mb-4 shadow-lg">
